...
evaluation of severe felt intensity.'' We request handling as a Research Article
documenting a public seismological data/software benchmark resource.
...
reproduces the 16-page manuscript, passes the released manuscript validator and
benchmark test suite, and reconstructs the recorded results and holdout predictions.
...
and data retain their stated MIT and CC0 terms). We will update the record with
the article DOI and journal URL if published.
