...
reproduces the 15-page manuscript, passes all 114 manuscript checks and 110
...
we disclose this as a preprint under Springer Nature's preprint policy and will
update the record with the article DOI and journal URL if published.
