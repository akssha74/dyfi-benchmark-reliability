...
|---|---|---|
| Select a listed article type | PASS | Research Article; manuscript documents a public data/software benchmark with original analyses |
...
| Peer review model | PASS | Journal states single-anonymous; author identities correctly retained |
...
| Single-anonymous peer review | PASS | Non-anonymized title page and public data are appropriate |
...
8. Upload `manuscript_source.zip`, `main.pdf`, `cover_letter.pdf`, and
